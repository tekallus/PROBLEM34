...
export default function App() {
  ...
  const handleSignIn = () => {
    setSession({ name: "New User", initials: "NU" });
  ...
  return (
    <SessionContext.Provider
      value={{ session, isAuthenticated, handleSignIn, handleSignOut }}
    >
...
function Header() {
  const { isAuthenticated, session, handleSignIn, handleSignOut } = useContext(
    SessionContext
  );
  return (
...
function Avatar() {
  ...
  return (
    <div className="flex items-center space-x-2 flex lg:flex-1 lg:justify-end">
